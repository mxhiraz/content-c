...
LAYOUT: pull-quote slide, 4:5 portrait. Matches @getintoai DNA — split composition:
- TOP HALF (~55%): solid black panel with mixed-case quote text and attribution
...
- A photoreal portrait of the named speaker if recognizable (Elon Musk, Sam Altman, etc.), OR a related contextual scene (courtroom for legal quote, podium for political quote, etc.).
